...
import com.example.williamhao.utils.ImageUtils;
	...
	private CharSequence replace(String text) {
		try {
			...
			while (matcher.find()) {
                ...
                bitmap = ImageUtils.zoomBitmap(bitmap, OtherUtils.dip2px(getContext(), Constant.Count.EMOTICONS_SIZE_DP), OtherUtils.dip2px(getContext(), Constant.Count.EMOTICONS_SIZE_DP));
