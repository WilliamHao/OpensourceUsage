...
/**
 * Created by williamhao on 8/13/15.
 */
public class MediaRecordUtil {
    private final String TAG = "MediaRecordUtil";
    private MediaRecorder mMediaRecorder;
    public static final int MAX_LENGTH = 1000 * 60 * 10;// 最大录音时长1000*60*10;
    private File file;

    public MediaRecordUtil(File file,ImageView view) {
        this.file = file;
        this.view=view;
    }
    public MediaRecordUtil(File file) {
        this.file = file;
    }
