package com.example.williamhao.customview.wheelview;
...
public class WheelView extends ScrollView {
    ...
    private void refreshItemView(int y) {
        ...
        for (int i = 0; i < childSize; i++) {
            ...
            if (position == i) {
                itemView.setTextColor(context.getResources().getColor(0));
            } else {
    ...
    public void setBackgroundDrawable(Drawable background) {
        ...
        if (null == paint) {
            paint = new Paint();
            paint.setColor(context.getResources().getColor(0));
